...
export default function Home() {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: "An end-to-end Data Science project predicting airline ticket prices using Random Forest Regression. Features complex data cleaning and extraction of temporal features.",
      tags: ["Python", "Scikit-Learn", "Feature Engineering", "Flask"],
      githubUrl: "https://github.com/Philbert72/Flight-Price-Prediction",
    },
    {
      ...
      tags: ["PyTorch", "GNN", "Cloud Security", "Research"],
      githubUrl: "https://github.com/Philbert72/Graph-Neural-Networks-for-Cloud-Security",
    },
    {
      title: "LunarLander DQN Agent",
      desc: "Deep Q-Network implementation for autonomous landing. Trained an agent to navigate the LunarLander environment using Reinforcement Learning.",
      tags: ["Python", "RL", "DQN", "OpenAI Gym"],
      githubUrl: "https://github.com/Philbert72/DQN-agent-for-LunarLander",
    },
    {
        ...
        <section id="hero" className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-12 px-6 md:px-20 max-w-7xl mx-auto">
          ...
          <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64">
            ...
            <div className="relative w-full h-full rounded-3xl overflow-hidden border-2 border-slate-800 bg-slate-900 shadow-2xl">
              <img src="/public/profile.jpeg" alt="Philbert Tan" className="w-full h-full object-cover" />
            </div>
          </div>
        </section>
      </FadeIn>
